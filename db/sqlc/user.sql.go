...
SELECT id, username, password, contact_number, created_at, updated_at, role_id FROM users
WHERE username = $1
`

func (q *Queries) SelectUser(ctx context.Context, username sql.NullInt32) (User, error) {
